...
?>
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                ...
                                <p class="text-muted page-title-alt">Gölal Yapı İçerik Yönetim Sistemine Hoş Geldiniz!</p>
                            </div>
                            <div class="col-sm-3">
									...
									<div class="bar-widget">
										<div class="table-box">
                                            ...
                                            <div class="table-detail text-right">
                                                <span data-plugin="peity-pie" data-colors="#9a3334,#c6911a" data-width="50" data-height="45"><?=$c_tekil;?>/<?=$c_cogul;?></span>
                                            </div>
								...
								<div class="card-box">
									<div class="bar-widget">
										<div class="table-box">
                                            ...
                                            <div class="table-detail text-right">
                                                <span data-plugin="peity-donut" data-colors="#c6911a,#9a3334" data-width="50" data-height="45"><?=$b_tekil;?>/<?=$b_cogul;?></span>
                                            </div>
